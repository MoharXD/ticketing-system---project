...
async function loadEvents() {
    try {
        ...
        container.innerHTML = events.map(e => {
            ...
            // 🚨 NEW: Map category to visual pill
...
eventForm.addEventListener('submit', async (e) => {
    ...
    const payload = {
        ...
        category: document.getElementById('event-category').value, // 🚨 NEW
...
window.editEvent = function(eventData) {
    ...
    document.getElementById('event-category').value = eventData.category || 'Movie'; // 🚨 NEW
...
window.resetEventForm = function() {
    ...
    document.getElementById('event-poster-file').value = ''; 
    document.getElementById('event-category').value = 'Movie'; // 🚨 NEW
